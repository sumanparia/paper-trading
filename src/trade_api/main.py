...
from trade_api.providers import get_provider_pool
from trade_api.services.data_feed import data_feed_service
from trade_api.services.quote_service import init_quote_service
from trade_api.routes import (
    live_data, orders, portfolio, instruments,
    smart_orders, margin, analytics, historical
)
...
async def root():
    return {
        ...
        "provider_pool": settings.provider_pool,
